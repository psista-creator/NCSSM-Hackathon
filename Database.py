...
class Database:
    ...
    def save_fish(self, frame, detection, habitat=None, ocean_region=None):
        ...
        self.db["fish"].append({"id": fish_id, "filename": filename, "label": detection.get("label", "fish"), "confidence": round(detection.get("confidence", 0.0), 3), "habitat": habitat, "ocean_region": ocean_region})
