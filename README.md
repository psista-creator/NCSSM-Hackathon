...
Built by Lucas, Shreeya, Praneel, and Anish.


## Inspiration
We are witnessing one of the biggest shifts in the Animal Kingdom, as environmental changes in the north and south poles divert many marine species towards deeper bodies of water. Studies by Duke’s Nicholas School of the Environment reveal that in North Carolina alone, marine populations are resorting to living inside Shipwrecks off the coast in order to escape the conditions of inland lakes and rivers caused by global warming. 

When looking at this issue, we saw one clear problem that affects both humans and marine species: interaction. Marine Scientists in North Carolina will not have enough data if species of fish continue to migrate towards areas that scientists cannot reach, and will not know which man-made sources cause the most harm. This has devastating economic potential for coastal areas, with Cape Pier’s reporting more than 14% less tourism because of the shifting fish populations, which can amount to billions in tourism money over the coming decades. Scientists need more data, while Beaches need more tourism to interact with marine wildlife.
